        ...
        <div>
            <div className="_header">
                <Navbar collapseOnSelect expand="lg" variant="dark">
                    {/* <Navbar.Brand href="#home"> <img style={{ width: '100px', height: '100px' }} src={logo} />WareHouse Management</Navbar.Brand> */}
                    <Navbar.Brand href="#home">WareHouse Management</Navbar.Brand>
